<div class="container">
<h1 style="text-align: center;margin-bottom: 50px">Job Fair</h1>
    <div class="row"> 
      <div class="col-sm-3">
        <ul class="list-group shadow-small side-nav"> 
          <a class="list-group-item active" href="#2"><span class="badge"> <i class="fa fa-angle-right"></i></span>  Instructions</a>
          <a class="list-group-item" href="#2"><span class="badge"> <i class="fa fa-angle-right"></i></span>  Apply for Job Fair</a>
          <a class="list-group-item" href="#2"><span class="badge"> <i class="fa fa-angle-right"></i></span>  Login</a>
      ...
      <div class="col-sm-9">
        <div class="admin-content">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="alert alert-danger" role="alert"><strong>Remember ,</strong> Read Instructions Carefully before applying</div>
            </div> 
          </div>
          <div class="panel panel-default">
            <div class="panel-body" style="white-space: pre-line;text-align: justify;" >
